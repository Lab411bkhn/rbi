...
class Tbl204DmHtha(models.Model):
    ...
    def __str__(self):
        return '%d : %s' %(self.id , self.susceptibility);
    class Meta:
        managed = False
...
class Tbl213DmImpactExemption(models.Model):
    ...
    def __str__(self):
        return '%d : Component Thickness %f' %(self.id, self.componentthickness)
...
class Tbl214DmNotPwht(models.Model):
    ...
    def __str__(self):
        return '%d : Tmin - Tref : %f' %(self.id, self.tmin_tref)
    class Meta:
        managed = False
...
class Tbl3B21SiConversion(models.Model):
    conversionfactory = models.IntegerField(db_column='conversionFactory', blank=True, null=False, primary_key=True)  # Field name made lowercase.
    ...
    def __str__(self):
        return 'C%d' %(self.conversionfactory);
    class Meta:
        managed = False
...
class Tbl511DfbThin(models.Model):
    ...
    def __str__(self):
        return '%d : API ART : %f' %(self.id, self.art)
    class Meta:
        managed = False
...
class Tbl52CaPropertiesLevel1(models.Model):
    ...
    def __str__(self):
        return '%d : API FLUID : %s' %(self.id, self.fluid)
...
class Tbl64DmLinningInorganic(models.Model):
    ...
    def __str__(self):
        return '%d : YEARS SINCE LAST INSP : %d' %(self.id, self.yearssincelastinspection)
    class Meta:
        managed = False
...
class Tbl65DmLinningOrganic(models.Model):
    ...
    def __str__(self):
        return '%d : YEARS IN SERVICE : %d' %(self.id, self.yearinservice)
    class Meta:
        managed = False
...
class Tbl71PropertiesStorageTank(models.Model):
    ...
    def __str__(self):
        return '%d :API FLUID : %d' %(self.id, self.fluid)
...
class Tbl74SccDmPwht(models.Model):
    ...
    def __str__(self):
        return '%d : API SVI : %d' %(self.id, self.svi)
    class Meta:
        managed = False
